...
class Logger:
    def __init__(self):
        ...
        self.tmp_log_filename = f"{self.logs_base_dir}/temp_game_log_{self.current_time}.txt"
    ...
    def setup_final_log_directory(self, score: int, mode: str = "gui", problem_file: Optional[str] = None) -> None:
        ...
        if mode == "file" and problem_file:
            ...
            self.final_log_dir = f"{self.logs_base_dir}/{self.current_time}_{score}_{problem_name}"
        else:
    ...
    def initialize_log(self, mode: str = "gui", problem_file: Optional[str] = None) -> None:
